...
namespace HikersMod.Components
{
    public class JetpackSprintEffectController : MonoBehaviour
    {
        ...
        private void LateUpdate()
        {
            ...
            _thrusterVector = Vector2.MoveTowards(_thrusterVector, SprintController.Instance.IsSprintActive && jetpackVisible && Config.IsSprintEffectEnabled ? OWInput.GetAxisValue(InputLibrary.moveXZ) : Vector2.zero, Time.deltaTime * 5);
