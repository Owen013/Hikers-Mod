...
public class JetpackSprintEffectController : MonoBehaviour
{
    ...
    private void LateUpdate()
    {
        ...
        _thrusterVector = Vector2.MoveTowards(_thrusterVector, SprintingController.Instance.IsSprintModeActive && jetpackVisible && Config.IsSprintEffectEnabled ? OWInput.GetAxisValue(InputLibrary.moveXZ) : Vector2.zero, Time.deltaTime * 5);
