...
public class AnimSpeedController : MonoBehaviour
{
    ...
    {
        float groundSpeed = _characterController.GetRelativeGroundVelocity().magnitude * (ModMain.SmolHatchlingAPI?.GetPlayerAnimSpeed() ?? 1);
        ...
        float underwaterMultiplier = ModMain.ImmersionAPI != null ? ModMain.ImmersionAPI.GetAnimSpeed() : 1;
